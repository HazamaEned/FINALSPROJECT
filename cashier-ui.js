        ...
        (function($) {
            ...
            function displayProducts(productsToDisplay) { 
                ...
                productsToDisplay.forEach((drug) => { // Use the stable ID from now on
                    ...
                    //click i for details
                    productCard.find('.product-desc').on('click', function(e) {
                ...
                function showDrugInfo(drug){
                    $('.drug-info-popup').remove();
                    
                    const popup = $(`
                        <div class="drug-info-popup">
                            <div class="popup-content">
                                <h3>${drug.name}</h3>
                                <div class = "popup-image-placeholder"></div
                                <p><strong>Brand:</strong> ${drug.brand}</p>
                                <p><strong>Form:</strong> ${drug.form}</p>
                                <p><strong>Price:</strong> ₱${drug.price.toFixed(2)}</p>
                                <p><strong>Stock:</strong> ${drug.stock ?? 0}</p>
                    ...
                    popup.on('click', function(e) {
                        if ($(e.target).is('.drug-info-popup')) popup.remove();
                    });
